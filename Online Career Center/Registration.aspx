<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Registration.aspx.cs" Inherits="Online_Career_Center.Registration" %>
  ...
  <div class="collapse navbar-collapse" id="navbarTogglerDemo02">
    ...
    <div class="container">
        ...
        <div class ="list-group-item">
            ...
            <td><asp:TextBox ID="txtPD" runat="server" MaxLength="3000" TextMode="MultiLine"/></td>
            <td><asp:RequiredFieldValidator ControlToValidate="txtPD" ID="rfvPD" runat="server" 
                ErrorMessage="Required Field"></asp:RequiredFieldValidator>
                </td></tr>

                <tr><td><asp:Label Text="Educational Details:" runat="server" /></td>
            <td><asp:TextBox ID="txtED" runat="server" MaxLength="3000" TextMode="MultiLine"/></td>
            <td><asp:RequiredFieldValidator ControlToValidate="txtED" ID="rfvED" runat="server" 
                ErrorMessage="Required Field"></asp:RequiredFieldValidator>
                </td></tr>
